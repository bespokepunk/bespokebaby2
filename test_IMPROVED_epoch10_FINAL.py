#!/usr/bin/env python3
"""Test IMPROVED model Epoch 10 - FINAL"""

import torch
from diffusers import StableDiffusionPipeline
import os

MODEL_PATH = "/Users/ilyssaevans/Downloads/bespoke_punks_IMPROVED-000010.safetensors"
BASE_MODEL = "runwayml/stable-diffusion-v1-5"
OUTPUT_DIR = "test_outputs/IMPROVED_epoch10_FINAL"

os.makedirs(OUTPUT_DIR, exist_ok=True)

print("=" * 80)
print("TESTING: IMPROVED Model - Epoch 10 (100% COMPLETE - FINAL)")
print("=" * 80)
...
print("\n" + "=" * 80)
print("FINAL EPOCH 10 COMPLETE - ALL TESTING DONE")
print("=" * 80)
print("\nNext: Compare all epochs to select best model")
