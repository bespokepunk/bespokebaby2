...
- More detailed caption generation matching training data
"""
...
class EnhancedPromptGenerator:
    ...
    def generate(self, image_path):
        ...
        print(f"\n{'='*60}")
        print(f"V2.5 ENHANCED ANALYSIS: {image_path}")
        print(f"{'='*60}\n")
        ...
        # Step 3: Map colors to features
        print("\nStep 3: Mapping colors to features...")
        hair_color = self.detect_hair_color(palette, exclude_bg=True)
        skin_color = self.map_skin_tone(face_info['skin'])
        eye_color = self.map_eye_color(face_info['eyes'])
    ...
    def detect_hair_color(self, palette, exclude_bg=True):
        """
        Detect hair color from palette, excluding background.
        Fixes the gray vs brown issue.
        """
...
class BespokePunkGeneratorV25:
    """
    Complete V2.5 generation pipeline with all enhancements.
    """
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("BESPOKE PUNK GENERATOR V2.5 - ENHANCED")
    print("="*60)
    print()

    if len(sys.argv) < 2:
        print("Usage: python bespoke_punk_generator_v2_5.py <image_path>")
        print()
        print("Example:")
        print("  python bespoke_punk_generator_v2_5.py test_image.jpg")
        sys.exit(1)

    image_path = sys.argv[1]
    lora_path = "Context 1106/bespoke_punks_sd15_512-000002.safetensors"

    # Initialize V2.5 generator
    generator = BespokePunkGeneratorV25(lora_path)

    # Generate
    result = generator.generate_from_image(image_path)

    # Save outputs
    output_512_path = "test_v2_5_output_512.png"
    output_24_path = "test_v2_5_output_24.png"
