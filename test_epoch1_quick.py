#!/usr/bin/env python3
"""Quick test of epoch 1 LoRA - generates a few test images."""
...
LORA_PATH = "/Users/ilyssaevans/Documents/GitHub/bespokebaby2/models/runpod_v2_7/bespoke_punks_v2_7-000001.safetensors"
OUTPUT_DIR = "/Users/ilyssaevans/Documents/GitHub/bespokebaby2/test_outputs_epoch1"
...
for name, prompt in TEST_PROMPTS:
    ...
    image = pipe(
        ...
        guidance_scale=7.5,
        width=512,  # Generate at 512 then we can downscale
        height=512,
    ).images[0]
...
print("\nLook for:")
print("  - Are the brown eyes actually brown (not cyan)?")
print("  - Does it look like pixel art style?")
print("  - Are the 24x24 versions recognizable?")
