#!/usr/bin/env python3
"""
Test SD 1.5 PERFECT Epoch 9
Quick test of epoch 9
"""
...
LORA_PATH = "/Users/ilyssaevans/Downloads/bespoke_punks_SD15_PERFECT-000009.safetensors"
OUTPUT_DIR = "/Users/ilyssaevans/Documents/GitHub/bespokebaby2/test_outputs_SD15_epoch9"
...
print("=" * 100)
print("TESTING SD 1.5 PERFECT - EPOCH 9")
print("=" * 100)
...
# Load pipeline
print("Loading SD 1.5 with epoch 9 LoRA...")
...
print("=" * 100)
print("✅ EPOCH 9 COMPLETE!")
print("=" * 100)
print(f"\nResults in: {OUTPUT_DIR}/")
print()
print("🎯 Epoch 9 may show some overtraining - compare with epochs 5-7!")
print()
