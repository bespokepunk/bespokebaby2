#!/usr/bin/env python3
"""Test IMPROVED model Epoch 4"""

import torch
from diffusers import StableDiffusionPipeline
import os

MODEL_PATH = "/Users/ilyssaevans/Downloads/bespoke_punks_IMPROVED-000004.safetensors"
BASE_MODEL = "runwayml/stable-diffusion-v1-5"
OUTPUT_DIR = "test_outputs/IMPROVED_epoch4"

os.makedirs(OUTPUT_DIR, exist_ok=True)

print("=" * 80)
print("TESTING: IMPROVED Model - Epoch 4")
print("=" * 80)
